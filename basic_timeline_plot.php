...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active" href="basic_timeline_plot.php">Basic Timeline Plot</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Basic Timeline Plot</h1>
                </div>
                <!-- /.col-lg-12 -->
                <div>
			...
			function addCompany() {
				...
				textvals[i] = $(selected).text();
							...
							$.getJSON(samsung, function(data) {
								...
								chart.addSeries({id: 'samsung', name: company_name, data: list, type: "line"}); 
					...
					chart.setTitle({text: title_text + " by " + set});
