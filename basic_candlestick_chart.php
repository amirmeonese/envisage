...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Basic Candlestick Chart</h1>
                </div>
                <!-- /.col-lg-12 -->
                <div>
			...
			<div class="panel panel-default">
					...
					<select id="combo" class="secondary" onchange="setChart()">
			...
			function setChart() {
                    ...
                    //if (title == "b") {
                            ...
                            while (chart.series.length > 0)
                                ...
                                var kpi = "getChartData.php?chart=candlestick&setID="+set+"&company="+company_name;
			...
			//if(chart.series[0] === undefined){
				...
				textvals[i] = $(selected).text();
							...
							$.getJSON(samsung, function(data) {
								...
								chart.addSeries({id: 'samsung', name: company_name, data: list, type: "boxplot"}); 
                                                                
                                                                var kpi = "getChartData.php?chart=candlestick&modeID="+set+"&company="+company_name;
