...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active" href="basic_area_chart.php">Basic Area Chart</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Basic Area Chart</h1>
                </div>
                <!-- /.col-lg-12 -->
                <div>
			...
			//if(chart.series[0] === undefined){
				...
				textvals[i] = $(selected).text();
							...
							$.getJSON(samsung, function(data) {
								...
								chart.addSeries({id: 'samsung', name: company_name, data: list, type: "area"}); 
