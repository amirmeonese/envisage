...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
								 ...
								 <li>
                                    <a class="active" href="area_chart.php">Area Chart</a>
                                </li>
								 <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Area Chart</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
				...
				textvals[i] = $(selected).text();
					...
					if (vals[i] == "samsung" && vals[i] == selected_samsung) {
						$(document).ready(function() {
							...
							$.getJSON(samsung, function(data) {
								...
								chart.addSeries({id: 'samsung', name: "Samsung Inc", data: list, type: "area"}); 
							});
					...
					if (vals[i] == "apple" && vals[i] == selected_apple) {
						$(document).ready(function() {
								...
								chart.addSeries({id: 'apple', name: "Apple Inc", data: list, type: "area"}); 
							});
					...
					if (vals[i] == "htc" && vals[i] == selected_htc) {
						$(document).ready(function() {
							...
							$.getJSON(htc, function(data) {
								...
								chart.addSeries({id: 'htc', name: "HTC Corp", data: list, type: "area"}); 
							});
					...
					if (vals[i] == "sony" && vals[i] == selected_sony) {
						$(document).ready(function() {
							...
							$.getJSON(sony, function(data) {
								...
								chart.addSeries({id: 'sony', name: "Sony Corp", data: list, type: "area"}); 
							});
