...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
                                    <a class="active" href="scatter_plot.php">Scatter Plot</a>
                                </li>
								<li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Scatter Plot</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
    ...
    <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#container').highcharts({
					...
					title: {
						text: 'Correlations between KPIs'
					},				
					yAxis: {
						title: {
							text: 'KPI'
			...
			function setChart() {
                    ...
                    var end = $('#xend').val();
                            ...
                            while (chart.series.length > 0)
								...
								chart.tooltip.options.formatter = function(){return  '<b>' + this.series.name +'</b><br><br/>'+list_text+':' + this.point.y +'<br/>'+title_text+':'+ this.point.x};
			...
			function addCompany() {
				...
				textvals[i] = $(selected).text();
                            ...
                            $.getJSON(samsung_x, function(data_x) {
								...
								for (var i in data_x)
								{
								   ...
								   var value_y = data_y[i].data;
									...
									var y = value_y, x = value_x;
									var samsung = [];

									for (var s = 0; s < x.length; s++) {
									   samsung[s] = [x[s],y[s]];																										 
									}                 
                                        chart.addSeries({id: 'samsung', name: "Samsung Inc", data: samsung, type: "scatter"});
								   ...
								   var value_y = data_y[i].data;
									...
									for (var s = 0; s < x.length; s++) {
									   apple[s] = [x[s],y[s]];																										 
                                        ...
                                        chart.addSeries({id: 'apple', name: "Apple Inc", data: apple, type: "scatter"});
								   ...
								   var value_y = data_y[i].data;
									...
									for (var s = 0; s < x.length; s++) {
									   htc[s] = [x[s],y[s]];																										 
                                        ...
                                        chart.addSeries({id: 'htc', name: "HTC Corp", data: htc, type: "scatter"});
								   ...
								   var value_y = data_y[i].data;
									...
									for (var s = 0; s < x.length; s++) {
									   sony[s] = [x[s],y[s]];																										 
                                        ...
                                        chart.addSeries({id: 'sony', name: "Sony Corp", data: sony, type: "scatter"});
					...
					chart.setTitle({text:  "Correlation between " + list_text + " and " + title_text});
