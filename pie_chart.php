...
<body>
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                <li>
								 ...
								 <li>
                                    <a class="active" href="pie_chart.php">Pie Chart</a>
                                </li>
								<li>
    ...
    <script type="text/javascript">
			...
			function setChart() {
                    ...
                    chart.tooltip.options.formatter = function(){return  '<b>' + this.point.name +'</b><br><br/>'+title_text+':' + this.point.y +'<br/>'};
				...
				if(point_name != null){
				   ...
				   for ( var i = 0; i < myData.length; i++ )
					   ...
					   if(point_name[i] === "Sony"){
						...
						var title_text = $('#combo option:selected').text();
						var list_text = $('#companyList option:selected').text();
